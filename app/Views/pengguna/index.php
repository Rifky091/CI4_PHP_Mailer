            ...
            <div id="login-card" style="margin-left: 5%; margin-right: 5%; padding-top: 3%;">
                <div class="row text-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <a href="<?= base_url().'/pengguna/listTugas' ?>" class="btn btn-dark w-75 mt-4 mb-4">EDIT TASK</a>
                        <a href="<?= base_url().'/pengguna/addTugas' ?>" class="btn btn-dark w-75 mb-4">CREATE TASK</a>
                    </div>
                </div>
            </div>
        </div>
